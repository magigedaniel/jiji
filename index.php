...
?>
    ...
    <div class="mainCnt" style="background:transparent">
        ...
        <section id="banner" class="education animatedParent" data-sequence="1000">
            <div class="container">
                <div id="banner-top">
                    <h1 alt="JijiCom Media" class="alC">Welcome to <span class="roundedMedium">JIJICOM MEDIA</span> a<br/>Place Of Technologies!</h1>
                </div>
            </div>
            ...
            <img id="banImg" class="lazy" data-original="images/nairobi.jpg" alt="JijiCom media, " >
